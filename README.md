...
- **Landing**: https://mayrafarfan.com/ (GitHub Pages desde `main`)
...
> Toda la info acá 👉 https://mayrafarfan.com/?src=flyer_wa
...
- Si se compra dominio propio (ej. `mayrafarfan.com`): agregar archivo `CNAME` con el dominio y configurar DNS. GitHub redirige la URL vieja `mayrafarfan.com` al dominio nuevo, así que los QR ya impresos siguen funcionando.
